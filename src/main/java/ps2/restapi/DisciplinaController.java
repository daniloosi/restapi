...
class DisciplinaController {
	...
	public DisciplinaController() {
		...
		disciplinas.add(new Disciplina(1, "Danilo", "S", "Sistemas", 3));
		disciplinas.add(new Disciplina(2, "Lucas", "C", "Ciencias", 2));
		disciplinas.add(new Disciplina(3, "Amanda", "D", "Direito", 4));
	}
